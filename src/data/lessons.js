export const lessons = [
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "items": [
          { "name": "LED", "image": "led.svg", "description": "Any color works!" },
          { "name": "220Ω Resistor", "image": "resistor.svg", "description": "Protects the LED" },
          { "name": "Breadboard", "image": "breadboard.svg", "description": "For easy connections" },
          { "name": "Jumper Wires", "image": "wires.svg", "description": "2 wires needed" }
        ]
      },
      {
        "id": "wiring-1",
