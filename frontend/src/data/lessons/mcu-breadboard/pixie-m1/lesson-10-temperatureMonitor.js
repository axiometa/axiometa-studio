...
Click the button below to establish a serial connection.`
    ...
    // ========================================
    {
      ...
      type: "wiring-step",
      title: "Connect Power",
      instruction: `Connect the thermistor module's Vin pin to 3.3V on the PIXIE.`,
      kitItemId: "TOOL-JW-001",
    ...
    // ========================================
    {
      ...
      instruction: `Connect the thermistor module's signal (A) to pin to Pin 3 on the PIXIE.`,
      kitItemId: "TOOL-JW-001",
